    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('professor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='turmas', to='pessoas.professor', verbose_name='Professor')),
            ],
        ),
        migrations.CreateModel(
            name='Turma',
            fields=[
                ...
                ('integrante_turma', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pessoas.aluno')),
            ],
        ),
    ]
